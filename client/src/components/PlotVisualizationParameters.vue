<template>
  <b-form-group id="nw-parameters">
    ...
    <b-form-input type="range" id="nw-nodeSeparation" size="sm" class="mb-3"
    ...
    <b-form-input type="range" id="nw-communitySeparation" size="sm" class="mb-3"
      v-model="visualizationParameters.communitySeparation" min=100 max=10000 step=100 @input="emit_changes()"
    ></b-form-input>

    <label id="nwParam" for="nw-gravity">Gravedad</label>
    <b-form-input type="range" id="nw-gravity" size="sm" class="mb-3"
